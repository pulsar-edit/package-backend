...
* [vcs](#module_vcs)
    ...
    * [~prepublishOwnership()](#module_vcs..prepublishOwnership)
...
| packObj | <code>object</code> | The full Package objects data from the backend. |
...
<a name="module_vcs..prepublishOwnership"></a>

### vcs~prepublishOwnership()

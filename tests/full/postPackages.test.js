...
describe("POST /api/packages", () => {
  ...
  test("Fails when no package name is provided", async () => {
    ...
    expect(res.body.message).toBe(
      "That repo does not exist, or is inaccessible: Repository is missing."
    );
  ...
  test("Successfully publishes new package", async () => {
    ...
    nock("https://api.github.com/")
      .get(
        "/repos/confused-Techie/my-non-original-package/collaborators?page=1"
      )
      .reply(200, [
        {
          node_id: "post-pkg-publish-test-user-node-id",
    ...
    nock("https://api.github.com")
      .get("/repos/confused-Techie/my-non-original-package")
      .reply(200, {
    ...
    nock("https://api.github.com")
      .get("/repos/confused-Techie/my-non-original-package/readme?ref=v1.0.0")
      .reply(200, {
    ...
    nock("https://api.github.com")
      .get("/repos/confused-Techie/my-non-original-package/tags")
      .reply(200, [
        {
          name: "v1.0.0",
          tarball_url:
            "https://api.github.com/repos/confused-Techie/my-non-original-package/tarball/refs/tags/v1.0.0",
          commit: {
            sha: "09f",
    ...
    nock("https://api.github.com")
      .get(
        "/repos/confused-Techie/my-non-original-package/contents/package.json?ref=v1.0.0"
      )
      .reply(200, {
        content: Buffer.from(
          JSON.stringify({
            ...
            repository:
              "https://github.com/confused-Techie/my-non-original-package",
            license: "MIT",
            version: "1.0.0",
          })
        ).toString("base64"),
    ...
    nock("https://api.github.com")
      .get("/repos/confused-Techie/my-non-original-package/contents/snippets")
      .reply(404);

    nock("https://api.github.com")
      .get("/repos/confused-Techie/my-non-original-package/contents/grammars")
      .reply(404);
